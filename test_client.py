...
#---
    ...
    ./wcs_client.py  GetCoverage  -s http://data.eox.at/instance00/ows? --coverageID  $elem   --subset_x epsg:4326 Long 3.5,3.6   --subset_y epsg:4326 Lat 43.3,43.4  --format tiff
...
#---
    ...
    ./wcs_client.py  GetCoverage  -s http://data.eox.at/instance00/ows? --coverageID    --subset_x epsg:4326 Long 2,3 --subset_y epsg:4326 Lat 43,44   --format tiff
...
#---
    ...
    ./wcs_client.py  GetCoverage  -s http://data.eox.at/instance00/ows? --coverageID    --subset_x epsg:4326 Long 3.5,3.6  --subset_y epsg:4326 Lat 43.3,43.4   --format tiff
...
#---
    ...
    ./wcs_client.py  GetCoverage  -s http://data.eox.at/instance00/ows? --coverageID   --subset_x epsg:4326 Long 4.76,5.10  --subset_y epsg:4326 Lat 50.52,50.78    --format tiff
